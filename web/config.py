...
class Config(object):
  ...
  AWS_S3_KEY_PREFIX = "yue0818/"
  AWS_S3_ACL = "private"
  AWS_S3_ENCRYPTION = "AES256"
  RESTORE_SNS= "arn:aws:sns:us-east-1:659248683008:yue0818_restore"
  THAW_SNS= "arn:aws:sns:us-east-1:659248683008:yue0818_thaw"

  AWS_GLACIER_VAULT = "mpcs-cc"

  # Change the ARNs below to reflect your SNS topics
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:yue0818_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:yue0818_job_results"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "yue0818_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "yue0818@mpcs-cc.com"
